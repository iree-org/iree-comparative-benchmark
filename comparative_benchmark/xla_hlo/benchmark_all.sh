...
declare -a GPU_BENCHMARK_NAMES=(
  ...
  "models/RESNET50_FP16_JAX_.+/inputs/.+/expected_outputs/.+"
  "models/RESNET50_BF16_JAX_.+/inputs/.+/expected_outputs/.+"
  "models/BERT_LARGE_FP32_JAX_.+/inputs/.+/expected_outputs/.+"
  "models/BERT_LARGE_FP16_JAX_.+/inputs/.+/expected_outputs/.+"
  "models/BERT_LARGE_BF16_JAX_.+/inputs/.+/expected_outputs/.+"
  "models/T5_LARGE_FP32_JAX_.+/inputs/.+/expected_outputs/.+"
  "models/T5_LARGE_FP16_JAX_.+/inputs/.+/expected_outputs/.+"
  "models/T5_LARGE_BF16_JAX_.+/inputs/.+/expected_outputs/.+"
