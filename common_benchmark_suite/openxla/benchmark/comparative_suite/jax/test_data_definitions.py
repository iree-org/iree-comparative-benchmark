...
# Bert large inputs.
BERT_LARGE_JAX_SEQLEN384_I32_BATCH_TEMPLATE = utils.ModelTestDataTemplate(
...
BERT_LARGE_JAX_SEQLEN384_I32_BATCHES = utils.build_batch_model_test_data(
    template=BERT_LARGE_JAX_SEQLEN384_I32_BATCH_TEMPLATE,
    batch_sizes=[1, 16, 24, 32, 48, 64, 512, 1024, 1280])

# Bert-Large Outputs.
BERT_LARGE_FP32_JAX_384X1024XF32_BATCH_TEMPLATE = utils.ModelTestDataTemplate(
...
BERT_LARGE_FP16_JAX_384X1024XF16_BATCH_TEMPLATE = utils.ModelTestDataTemplate(
...
BERT_LARGE_BF16_JAX_384X1024XBF16_BATCH_TEMPLATE = utils.ModelTestDataTemplate(
...
BERT_LARGE_FP32_JAX_384X1024XF32_BATCHES = utils.build_batch_model_test_data(
    template=BERT_LARGE_FP32_JAX_384X1024XF32_BATCH_TEMPLATE,
    batch_sizes=[1, 16, 24, 32, 48, 64, 512, 1024, 1280])

BERT_LARGE_FP16_JAX_384X1024XF16_BATCHES = utils.build_batch_model_test_data(
    template=BERT_LARGE_FP16_JAX_384X1024XF16_BATCH_TEMPLATE,
    batch_sizes=[1, 16, 24, 32, 48, 64, 512, 1024, 1280])

BERT_LARGE_BF16_JAX_384X1024XBF16_BATCHES = utils.build_batch_model_test_data(
    template=BERT_LARGE_BF16_JAX_384X1024XBF16_BATCH_TEMPLATE,
    batch_sizes=[1, 16, 24, 32, 48, 64, 512, 1024, 1280])
